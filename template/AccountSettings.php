      ...
      <form class="row" action="" method="post">
        <div class="col-md-6">
          <div class="mb-10 px-10">
            ...
            <input type="text" name="label" placeholder="<?php echo $AccountInfo['account_label'];?>" class="form-control">
            <input type="hidden" name="username" value="<?php echo $AccountInfo['account_username']?>"></div>
        </div>
	<div class="col-md-12">
		<div class="mb-10 px-10">
			<input type="submit" name="update" value="Update Account Label" class="btn btn-primary btn-sm text-white"> </div>
	</div>
</form>
<hr>
...
if (isset($_POST['update']))
{
    ...
    $sql = mysqli_query($connect, "UPDATE `hosting_account` SET `account_label`='" . $_POST['label'] . "' WHERE `account_username`='" . $FormData['username'] . "'");
    if ($sql > 0)
    {
        $_SESSION['message'] = '<div class="alert alert-success" role="alert">
										  ...
										  Account label updated <b>successfully!</b>
										</div>';
